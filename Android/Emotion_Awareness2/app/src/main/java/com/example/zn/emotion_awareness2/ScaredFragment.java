...
public class ScaredFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.fragment_scared,container,false);
        ...
        while (res.moveToNext()){
            ...
            Log.i("res.moveToNext()", res.getString(4));
            Log.i("res.moveToNext()", res.getString(7));

            float f=Float.parseFloat(res.getString(4))*100;
