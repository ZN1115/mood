...
public class AnxiousFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view=inflater.inflate(R.layout.fragment_anxious,container,false);
        ...
        while (res.moveToNext()){
            ...
            Log.i("res.moveToNext()", res.getString(3));
            Log.i("res.moveToNext()", res.getString(7));

            float f=Float.parseFloat(res.getString(3))*100;
